...
<body>
  <div class="session">
    <div class="left" style="background: url('image/admin_loginBg.jpg') no-repeat top center / cover" ;>
    ...
    <form action="dashboard.php" method="POST" class="log-in" autocomplete="off">
      <h4>Admin <span>Login</span></h4>
      <p>Welcome back! Log in to your account to view today's customers:</p>
      <div class="floating-label">
        <input placeholder="Username" type="text" name="username" id="username" value="admin" autocomplete="off"
          required>
      ...
      <div class="floating-label">
        <input placeholder="Password" type="password" name="password" id="password" value="welcome" autocomplete="off"
          required>
